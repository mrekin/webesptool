...
export const MESHCORE_CONFIG_METADATA = {
    ...
    fieldGroups: {
        // Name & Location
        name: 'location', lat: 'location', lon: 'location', 'owner.info': 'location',
        // Identity & Access
        'prv.key': 'identity', 'guest.password': 'identity',
        ...
        'flood.max.unscoped': 'advanced', 'flood.max.advert': 'advanced',
        'flood.advert.interval': 'advanced', 'advert.interval': 'advanced',
        'bridge.baud': 'advanced', 'bridge.channel': 'advanced',
        'bridge.delay': 'advanced', 'bridge.secret': 'advanced', 'bridge.source': 'advanced'
