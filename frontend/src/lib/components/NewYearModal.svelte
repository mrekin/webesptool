<script lang="ts">
    ...
    let fireworks = Array.from({ length: 50 }, (_, i) => ({
        ...
        color: ['#ff0', '#f0f', '#0ff', '#f00', '#0f0', '#00f', '#ff8800', '#ff0088'][
        ...
        >
            ...
            <div class="pointer-events-none absolute inset-0 overflow-hidden">
                {#each fireworks as firework}
                    ...
                    >
                        <div
                            class="animate-spark"
                            style="width: {firework.size}px; height: {firework.size}px; background-color: {firework.color}; box-shadow: 0 0 {firework.size *
                                2}px {firework.color}, 0 0 {firework.size * 4}px {firework.color};"
                        ></div>
                    </div>
                {/each}
            </div>
            ...
            <div class="relative z-10 flex flex-col items-center justify-center space-y-8 py-8">
                ...
                <div class="animate-bounce-slow">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        class="h-64 w-64 drop-shadow-2xl"
                        viewBox="0 0 200 200"
                    >
                        <!-- Tree shadow -->
                ...
                <div class="space-y-4 text-center">
                    <h2
                        class="animate-gradient-x bg-gradient-to-r from-green-400 via-red-500 to-green-400 bg-clip-text text-4xl font-bold text-transparent"
                    >
                ...
                <!-- Decorative emoji -->
                <div class="animate-bounce-slow flex gap-4 text-4xl">
